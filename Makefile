...
lint-py:  ## lint python with ruff
	python -m ruff check nomad_pydantic
	python -m ruff format --check nomad_pydantic
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix nomad_pydantic
	python -m ruff format nomad_pydantic
...
test:  ## run python tests
	python -m pytest -v nomad_pydantic/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v nomad_pydantic/tests --cov=nomad_pydantic --cov-report term-missing --cov-report xml
