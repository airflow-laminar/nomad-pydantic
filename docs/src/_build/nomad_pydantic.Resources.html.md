...
#### *field* cpu *: int | None* *= None* *(alias 'CPU')*

#### *field* cores *: int | None* *= None* *(alias 'Cores')*

#### *field* memory_mb *: int | None* *= None* *(alias 'MemoryMB')*

#### *field* memory_max_mb *: int | None* *= None* *(alias 'MemoryMaxMB')*
